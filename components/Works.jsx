    ...
    return (
        <>
            ...
            <div className="relative font-inter antialiased items-center" id="work">
                <main className="relative min-h-screen flex justify-center flex-col bg-slate-900 overflow-hidden">
                    <div className="md:w-scree flex flex-col md:flex-row md:px-6 py-24" >
                        ...
                        <div className="relative h-auto w-full z-30 md:right-20 p-4" data-aos="fade-up">
                            <h1 className='relative text-3xl font-[100] text-sky-400 text-center mt-4 md:float-right md:mt-10 md:mr-2'>Featured Project</h1>
                                ...
                                <CardBody>
                                    <div className="mb-3 flex items-center justify-between">
                                        <Typography variant="h5" color="blue-gray" className="font-medium">
                                            <p className='mt-4 md:text-right text-3xl text-center md:text-4xl font-bold'>Agriculture Monitoring System </p>
                                        </Typography>
                            ...
                            <div className="flex h-auto gap-4  my-4 float-right md:mr-4">
                                <Link className='md:text-2xl text-cyan-600' href='https://github.com/deepakkumar182002/AgricultureMonitoring'>
                                    <FiGithub />
                                </Link>
                                <Link className='md:text-2xl text-cyan-600' href='https://agriculture-monitoring.netlify.app/'>
                                    <BsBoxArrowUpRight />
                                </Link>
                            </div>
                        </div>
                        ...
                        <div className="relative h-auto w-full z-30 md:right-20 p-4" data-aos="fade-up">
                            ...
                            <Card className="z-30 w-full h-auto md:h-auto max-w-[760px] shadow-lg backdrop-blur-sm bg-slate-800/10 text-white mt-4">
                                ...
                                <CardBody>
                                    <div className="mb-3 flex items-center justify-between">
                                        <Typography variant="h5" color="blue-gray" className="font-medium">
                                            <p className='mt-4 md:text-right text-3xl text-center md:text-4xl font-bold'>Embedded Learning Site</p>
                                        </Typography>
                            ...
                            <div className="flex h-auto gap-4  my-4 float-right md:mr-4">
                                ...
                                <Link className='md:text-2xl text-cyan-600' href='https://freemepado.vercel.app/'>
                                    <BsBoxArrowUpRight />
                                </Link>
                            </div>
                        </div>
            ...
            <div className="relative font-inter antialiased items-center">
                <main className="relative min-h-screen flex justify-center flex-col bg-slate-900 overflow-hidden">
                    <div className="md:w-scree flex flex-col md:flex-row md:px-6 py-10" >
                        <Link href='https://deep-weatherstation.netlify.app/' data-aos="fade-right">
                            <div className="max-w-sm w-auto mx-auto items-center flex flex-col lg:max-w-none group" data-spotlight>
                                <div className="relative h-full w-[350px] md:w-[700px] bg-slate-800 rounded-3xl p-px before:absolute before:w-80 before:h-80 before:-left-40 before:-top-40 before:bg-slate-400 before:rounded-full before:opacity-0 before:pointer-events-none before:transition-opacity before:duration-500 before:translate-x-[var(--mouse-x)] before:translate-y-[var(--mouse-y)] before:group-hover:opacity-100 before:z-10 before:blur-[100px] after:absolute after:w-96 after:h-96 after:-left-48 after:-top-48 after:bg-indigo-500 after:rounded-full after:opacity-0 after:pointer-events-none after:transition-opacity after:duration-500 after:translate-x-[var(--mouse-x)] after:translate-y-[var(--mouse-y)] after:hover:opacity-10 after:z-30 after:blur-[100px] overflow-hidden">
                                    <div className="relative h-full w-[350px] md:w-[700px] bg-slate-900 p-4 rounded-[inherit] z-20 overflow-hidden">
                                        <div className="absolute bottom-0 translate-y-1/2 left-1/2 -translate-x-1/2 pointer-events-none -z-10 w-1/2 aspect-square" aria-hidden="true">
                        ...
                        <div className="relative h-auto w-full z-30 md:right-20 p-4" data-aos="fade-up">
                            ...
                            <Card className="z-30 w-full h-auto md:h-auto max-w-[760px] shadow-lg backdrop-blur-sm bg-slate-800/10 text-white mt-4">
                                ...
                                <CardBody>
                                    <div className="mb-3 flex items-center justify-between">
                                        <Typography variant="h5" color="blue-gray" className="font-medium">
                                            <p className='mt-4 md:text-right text-3xl text-center md:text-4xl font-bold'>Weather Station & realtime Data </p>
                                        </Typography>

                                    </div>
                                    <Typography color="gray" className='text-justify'>
                                        This is an embedded-based project in which a real-time weather station has been created using a microcontroller, sensors, Firebase Web API, web development & weather API. The Firebase platform has been used to visualize the real-time data of sensors.
                                    </Typography>
                                    <div className="group mt-8 inline-flex flex-wrap w-full md:items-start items-center gap-3">
                                        <Tooltip content="HTML" className="relative z-30 backdrop-blur-sm bg-slate-200 text-slate-950">
                                            <span className="cursor-pointer rounded-full border border-gray-200/5 bg-gray-900/5 p-3 text-white transition-colors hover:border-gray-200/10 hover:bg-gray-900/10 hover:!opacity-100 group-hover:opacity-70">
                            ...
                            <div className="flex h-auto gap-4  my-4 float-right md:mr-4">
                                <Link className='md:text-2xl text-cyan-600' href='https://github.com/deepakkumar182002/Realtime-WeatherApp-DHT11-Data'>
                                    <FiGithub />
                                </Link>
                                <Link className='md:text-2xl text-cyan-600' href='https://deep-weatherstation.netlify.app/'>
                                    <BsBoxArrowUpRight />
                                </Link>
                            </div>
                        </div>
            ...
            <div className="relative font-inter antialiased items-center">
                <main className="relative min-h-screen flex justify-center flex-col bg-slate-900 overflow-hidden">
                    <div className="md:w-scree flex flex-col md:flex-row md:px-6 py-10" >
                        <Link href='https://edtech-courses-2.netlify.app/' data-aos="fade-right">
                            <div className="max-w-sm w-auto mx-auto items-center flex flex-col lg:max-w-none group" data-spotlight>
                                <div className="relative h-full w-[350px] md:w-[700px] bg-slate-800 rounded-3xl p-px before:absolute before:w-80 before:h-80 before:-left-40 before:-top-40 before:bg-slate-400 before:rounded-full before:opacity-0 before:pointer-events-none before:transition-opacity before:duration-500 before:translate-x-[var(--mouse-x)] before:translate-y-[var(--mouse-y)] before:group-hover:opacity-100 before:z-10 before:blur-[100px] after:absolute after:w-96 after:h-96 after:-left-48 after:-top-48 after:bg-indigo-500 after:rounded-full after:opacity-0 after:pointer-events-none after:transition-opacity after:duration-500 after:translate-x-[var(--mouse-x)] after:translate-y-[var(--mouse-y)] after:hover:opacity-10 after:z-30 after:blur-[100px] overflow-hidden">
                                    <div className="relative h-full w-[350px] md:w-[700px] bg-slate-900 p-4 rounded-[inherit] z-20 overflow-hidden">
                                        <div className="absolute bottom-0 translate-y-1/2 left-1/2 -translate-x-1/2 pointer-events-none -z-10 w-1/2 aspect-square" aria-hidden="true">
                        ...
                        <div className="relative h-auto w-full z-30 md:right-20 p-4" data-aos="fade-up">
                            ...
                            <Card className="z-30 w-full h-auto md:h-auto max-w-[760px] shadow-lg backdrop-blur-sm bg-slate-800/10 text-white mt-4">
                                ...
                                <CardBody>
                                    <div className="mb-3 flex items-center justify-between">
                                        <Typography variant="h5" color="blue-gray" className="font-medium">
                                            <p className='mt-4 md:text-right text-3xl text-center md:text-4xl font-bold'>Ed-Tech Site</p>
                                        </Typography>

                                    </div>
                                    <Typography color="gray" className='text-justify'>
                                        &apos;Ed tech site&apos; is an innovative online learning platform built with React.js and Node.js. It offers a seamless experience for users to explore courses, purchase subscriptions, and enhance their skills. With a sleek Bootstrap interface and powerful JavaScript functionalities, it revolutionizes the way we learn online.                                    </Typography>
                                    <div className="group mt-8 inline-flex flex-wrap w-full md:items-start items-center gap-3">
                                        <Tooltip content="React.js" className="relative z-30 backdrop-blur-sm bg-slate-200 text-slate-950">
                                            <span className="cursor-pointer rounded-full border border-gray-200/5 bg-gray-900/5 p-3 text-white transition-colors hover:border-gray-200/10 hover:bg-gray-900/10 hover:!opacity-100 group-hover:opacity-70">
                                                <FaReact className='text-2xl' />
                                        ...
                                        <Tooltip content="Node.js" className="relative z-30 backdrop-blur-sm bg-slate-200 text-slate-950">
                                            <span className="cursor-pointer rounded-full border border-gray-200/5 bg-gray-900/5 p-3 text-white transition-colors hover:border-gray-200/10 hover:bg-gray-900/10 hover:!opacity-100 group-hover:opacity-70">
                            ...
                            <div className="flex h-auto gap-4  my-4 float-right md:mr-4">
                                <Link className='md:text-2xl text-cyan-600' href='https://github.com/deepakkumar182002/edtech1'>
                                    <FiGithub />
                                </Link>
                                <Link className='md:text-2xl text-cyan-600' href='https://edtech-courses-2.netlify.app/'>
                                    <BsBoxArrowUpRight />
                                </Link>
                            </div>
                        </div>
