        ...
        <main className="relative min-h-screen flex flex-col justify-start bg-slate-900 overflow-hidden">
          <div className="w-full max-w-6xl mx-auto px-4 md:px-6 py-24">
            ...
            >
              ...
              >
                <div className="relative  h-full bg-slate-900 p-6 pb-8 rounded-[inherit] z-20 overflow-hidden">
                  ...
                  <div className="relative rounded-lg hover:bg-cyan-600 duration-300">
                    <Image
                      src={deep}
                      className="rounded-lg hover:opacity-70 cursor-pointer"
                      alt=""
                    />
                  </div>
                </div>
              ...
              <div
                className=" mt-2 md:ml-4 md:w-[600px] w-auto h-auto"
                data-aos="fade-left"
              >
                ...
                <div className="mt-4">
                  <div className="-tracking-tighter text-justify font-[200] text-white">
                    ...
                    , with an expansive skill set that encompasses both{' '}
                    <Link
                      href="/"
                      className="text-cyan-400 underline font-bold"
                    >
                    ...
                    technologies. With a passion for creating efficient,
                    scalable web applications and a knack for designing
                    intuitive user interfaces, I have consistently driven
                    projects from concept to deployment.
                  </div>
                  <div className="pt-4 -tracking-tighter text-justify font-[200]">
                  ...
                  <div className=" mt-4 flex flex-row row-auto md:gap-20 gap-5 text-sm ">
                    <div className="flex flex-col gap-4">
                      <Link
                        ...
                        className="hover:underline flex gap-2 items-center text-cyan-500"
                      >
                        <FaReact />
                        ReactJS
                      </Link>
                      ...
                      <Link
                        ...
                        className="hover:underline flex gap-2 items-center text-green-500"
                      >
                        <IoLogoNodejs />
                        NodeJS
                      </Link>
                      <Link
                        ...
                        className="hover:underline flex gap-2 items-center text-rose-600"
                      >
                        <SiNpm />
                        NPM
                      </Link>
                      <Link
                        ...
                        className="hover:underline flex gap-2 items-center text-orange-500"
                      >
                        <SiJavascript />
                        ES+
                      </Link>
                    ...
                    <div className="flex flex-col gap-4">
                      ...
                      <Link
                        href="/"
                        className="hover:underline flex gap-2 items-center text-yellow-400"
                      >
                        <TbBrandJavascript />
                        JavaScript
                      </Link>
                      <Link
                        href="/"
                        className="hover:underline flex gap-2 items-center text-blue-400"
                      >
                        <RiTailwindCssFill />
                        TailwindCSS
                      </Link>
                      <Link
                        href="/"
                        className="hover:underline flex gap-2 items-center text-pink-400"
                      >
                        <BsFiletypeScss />
                        SCSS
                      </Link>
                    ...
                    <div className="flex flex-col gap-4">
                      <Link
                        href="/"
                        className="hover:underline flex gap-2 items-center text-purple-900"
                      >
                        <Image src={gpt} height={18} width={18} alt="chatgpt" />
                        ChatGPT
                      </Link>
                      <Link
                        href="/"
                      ...
                      <Link
                        href="/"
                        className="hover:underline flex gap-2 items-center text-blue-800"
                      >
                        <SiStrapi />
                        Starpi
                      </Link>
