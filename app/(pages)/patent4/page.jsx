...
import CircuitDesign from './img/hydroponic patent.jpg';
...
import v1 from './img/perspectiv v.png';
import v2 from './img/front v.png';
import v3 from './img/back v.png';
import v4 from './img/bottum v.png';
import v5 from './img/left v.png';
import v6 from './img/right v.png';
import v7 from './img/top v.png';
import v8 from './img/perspectiv v.png';
            ...
            >
                  ...
                  <div className="mb-3 flex items-center justify-between">
                    ...
                    >
                      <div className="mt-4 md:text-right text-3xl text-center md:text-4xl font-bold">
                        Device for the Monitoring and distribution of nutrient
                        for Hydroponic
                      </div>
                    </Typography>
                  </div>
              ...
              <div className="flex h-auto gap-4 my-4 float-right md:mr-4">
                <Link
                  ...
                  href="https://www.registered-design.service.gov.uk/find/6326599"
                >
                  <BsBoxArrowUpRight />
                </Link>
              </div>
