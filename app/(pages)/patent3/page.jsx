...
import CircuitDesign from './img/Medi Drone Certificate.jpg';
...
import v1 from './img/perspective V.png';
import v2 from './img/front perspective V.png';
import v3 from './img/front V.png';
import v4 from './img/Bottum V.png';
import v5 from './img/back V.png';
import v6 from './img/left V.png';
import v7 from './img/right V.png';
import v8 from './img/top V.png';
            ...
            >
                  ...
                  <div className="mb-3 flex items-center justify-between">
                    ...
                    >
                      <div className="mt-4 md:text-right text-3xl text-center md:text-4xl font-bold">
                        Medi-Drone : Medicine delivery Drone
                      </div>
                    </Typography>
                  </div>
              ...
              <div className="flex h-auto gap-4 my-4 float-right md:mr-4">
                <Link
                  ...
                  href="https://www.registered-design.service.gov.uk/find/6317960"
                >
                  <BsBoxArrowUpRight />
                </Link>
              </div>
