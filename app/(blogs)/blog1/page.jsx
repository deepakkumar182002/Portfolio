        ...
        <div className="container p-4 w-full md:w-3/5 mx-auto h-full mt-4 bg-white text-black">
          ...
          <div className="w-full h-auto p-4">
            ...
            <p className="text-justify pt-4 text-[20px] tracking-wider">
              ...
              Students also get access to JetBrains' suite of integrated
              development environments (IDEs), like IntelliJ IDEA, which are
              widely used in the industry for writing clean, efficient code.
              Furthermore, the pack provides free credits for Amazon Web
              Services (AWS), allowing students to explore cloud computing
              services, deploy applications, and work on scalable projects.
              DigitalOcean offers additional cloud services, giving students the
              flexibility to host and manage their projects seamlessly.
            </p>
            <p className="text-justify pt-4 text-[20px] tracking-wider">
              ...
              obtain a free domain name from Namecheap, which is ideal for
              setting up personal portfolios or project websites. Canva provides
              tools for designing graphics, useful for creating visually
              appealing project presentations and marketing materials. Microsoft
              Azure offers even more cloud services and developer tools, while
              MongoDB grants access to powerful database management systems.
              These platforms not only enhance the learning experience but also
